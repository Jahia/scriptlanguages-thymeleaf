...
import org.jahia.services.render.scripting.thymeleaf.support.expression.variables.FacetUtils;
import org.jahia.services.render.scripting.thymeleaf.support.expression.variables.FunctionUtils;
import org.jahia.services.render.scripting.thymeleaf.support.expression.variables.JCRUtils;
import org.jahia.services.render.scripting.thymeleaf.support.expression.variables.UserUtils;
import org.jahia.services.render.scripting.thymeleaf.support.expression.variables.WorkflowUtils;
...
public class JahiaVariableExpressionEvaluator extends OgnlVariableExpressionEvaluator {
    ...
    protected Map<String, Object> computeAdditionalContextVariables(final IProcessingContext processingContext) {
        LOGGER.info("Loading Jahia Context Variables");
