...
import org.jahia.modules.render.scripting.services.template.include.ModuleService;
...
public class ModuleElementProcessor extends AbstractUnescapedTextChildModifierElementProcessor {
    ...
    protected String getText(final Arguments arguments,
        ...
        final String nodeName = element.getAttributeValue(DXDialectConstants.DX_ATTR_NODE_NAME);
        ...
        final Integer listLimit = ProcessorUtil.getIntegerValue(element, attributeMap, DXDialectConstants.DX_ATTR_LIST_LIMIT, -1);
